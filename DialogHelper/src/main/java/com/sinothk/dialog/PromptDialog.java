...
//                outAnim.setStartOffset(delayTime);
    ...
    public void showWarnAlert(String text, DialogButton button) {
        showWarnAlert(text, button, false);
    }

    public void showWarnAlert(String text, DialogButton button, boolean withAnim) {
     ...
     */
    public void showWarnAlert(String text, DialogButton button1, DialogButton button2, boolean withAnim) {
        showAlert(text, withAnim, button1, button2);
    }

    public void showWarnAlert(String text, DialogButton button1, DialogButton button2) {
        showWarnAlert(text, button1, button2, true);
    }

    public void showAlertSheet(String title, boolean withAnim, DialogButton... button) {
        showAlert(title, withAnim, button);
    }

    private void showAlert(String text, boolean withAnim, DialogButton... button) {
        if (button.length > 2) {
